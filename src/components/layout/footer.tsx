...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary-light dark:bg-primary-dark text-primary-dark dark:text-primary-light p-4 w-full inline-flex flex-row items-center justify-between">
      <div>
